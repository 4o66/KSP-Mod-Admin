...
namespace KSPModAdmin.Utils.CommonTools.TreeList
{
	...
	public class ViewSetting
	{
		...
		bool		m_showCheckBoxes = false; // Added by BH
		...
		public ViewSetting(TreeListViewEx owner)
		{
			m_owner = owner;
		}
	}
    ...
    {
        bool            m_AutoSize = false; // Added by BH
		int				m_leftMargin = 5;
		...
		public CollumnSetting(TreeListViewEx owner)
		{
			m_owner = owner;
		}
	}
	...
	public class RowSetting
	{
		...
		public RowSetting(TreeListViewEx owner)
		{
			m_owner = owner;
		}
	}
