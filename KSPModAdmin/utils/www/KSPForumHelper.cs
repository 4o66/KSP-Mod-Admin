...
{
    public static class KSPForumHelper
    {
        /// <summary>
        ...
        public static ModInfo GetModInfo(string forumURL)
        {
            ...
            if (ParseSite(wwwHelper.Load(forumURL), ref modInfo))
                return modInfo;
            else
                return null;
        }
        ...
        {
            string siteContent = wwwHelper.Load(forumURL);
            ...
            foreach (var entry in matches)
            {
                ...
                {
                    siteContent = wwwHelper.Load(url);
