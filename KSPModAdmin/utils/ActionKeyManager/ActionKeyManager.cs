...
{
    /// <summary>
    /// Signiture of the callback function when a key gets in KeyDown state.
    /// </summary>
    /// <param name="actionKeyInfo">The infos about the pressed key.</param>
    ...
    public class ActionKeyManager
    {
        ...
        /// <returns>True if key was handled (In this case no other callback functions will be called).</returns>
        public bool HandleKeyMessage(ref System.Windows.Forms.Message msg)
        {
            VirtualKey key = (VirtualKey)msg.WParam.ToInt32();
            KeyDownLParamHelper kdLPHelper = new KeyDownLParamHelper(msg.LParam.ToInt32());
